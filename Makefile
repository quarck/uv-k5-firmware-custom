...
full:
	$(RM) $(call FixPath, $(TARGET).bin $(TARGET).packed.bin) QRCK*.bin
	$(MAKE) build ENABLE_FMRADIO=1 ENABLE_MESSENGER=1 ENABLE_MESSENGER_DELIVERY_NOTIFICATION=1 ENABLE_MESSENGER_NOTIFICATION=1 ENABLE_SPECTRUM=1
	$(MAKE) build ENABLE_DOPPLER=1 ENABLE_SPECTRUM=1 ENABLE_FMRADIO=1
	$(MAKE) build ENABLE_SPECTRUM=1 ENABLE_FMRADIO=1
	$(MAKE) build ENABLE_4732=1 ENABLE_4732SSB=1  ENABLE_SPECTRUM=1

test:
	$(RM) $(call FixPath, $(TARGET).bin $(TARGET).packed.bin) QRCK*.bin
	$(MAKE) build ENABLE_FMRADIO=0 ENABLE_MESSENGER=1 ENABLE_MESSENGER_DELIVERY_NOTIFICATION=1 ENABLE_MESSENGER_NOTIFICATION=1 VSCODE_DEBUG=1
